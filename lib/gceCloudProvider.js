 ...
 *                    elected master.
 */
GceCloudProvider.prototype.electMaster = function electMaster(instances) {
 ...
 *                    }
 */
GceCloudProvider.prototype.getMasterCredentials = function getMasterCredentials(mgmtIp, mgmtPort) {
    let credentials;
    let masterBigIp;
 ...
 *
 */
GceCloudProvider.prototype.getMasterStatus = function getMasterStatus() {
 ...
 */
GceCloudProvider.prototype.masterElected = function masterElected(instanceId) {
 ...
 * @returns {Promise} A promise which will be resolved when processing is complete.
 */
GceCloudProvider.prototype.tagMasterInstance = function tagMasterInstance(masterIid, instances) {
    const vms = {};
 ...
 * @returns {Promise} A promise which will be resolved when processing is complete.
 */
GceCloudProvider.prototype.masterInvalidated = function masterInvalidated(instanceId) {
 ...
 *                    is complete
 */
GceCloudProvider.prototype.putMasterCredentials = function putMasterCredentials() {
